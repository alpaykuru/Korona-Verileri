...
class Graphic extends React.Component {
  state = { selectedIl: 'Yeni Haber',kumulatif: false,graphData:[] };
  ...
  render() {
    ...
    <form onSubmit={this.handleSubmit}  style={{ height: 350 }} className="App">
      ...
      />
      <div>
      <select value={this.state.selectedIl} onChange={event => this.setState({ selectedIl: event.target.value })}>
          <option defaultValue value="Ankara">Ankara</option>
       ...
       <button>Grafiği Güncelle</button>
      </div>
    </form>
  );
  }
